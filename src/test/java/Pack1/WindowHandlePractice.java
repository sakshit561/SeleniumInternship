...
public class WindowHandlePractice{
	...
	public static void main(String[] args) {
		...
		d.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("learning");
		d.findElement(By.xpath("//*[@id=\"login-form\"]/div[4]/div/label[2]/span[2]")).click();
		WebDriverWait w1 =new WebDriverWait(d, Duration.ofSeconds(3));
		...
		d.findElement(By.cssSelector("input[name=signin]")).click();
